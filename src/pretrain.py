...
from src.datasets.nih_chestxray import make_nih_pretrain
...
def main(args, resume_preempt=False):
    ...
    copy_data = args['meta'].get('copy_data', False)
    ...
    _, unsupervised_loader, unsupervised_sampler = make_nih_pretrain(
        transform=transform,
